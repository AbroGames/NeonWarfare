...
_Auto-generated. Last updated 2026-08-07T11:49:01.999Z._
...
- [client-server-physics-sync-defects](pages/client-server-physics-sync-defects.md) — category: concept | tags: [physics, networking, debt, fragile] | ## Суть
- [client-server-subsystem-split](pages/client-server-subsystem-split.md) — category: decision | tags: [architecture, networking, entities] | ## Что решено
...
- [main-menu-structure](pages/main-menu-structure.md) — category: decision | tags: [main-menu, ui, plan, issue-12, issue-94, issue-16] | План эпика #12 (Creation of MainMenu), записан в `plans/main-menu-general-plan.md`.
...
- [no-automated-tests](pages/no-automated-tests.md) — category: decision | tags: [testing, debt] | ## Что наблюдается
- [single-authoritative-logic-path](pages/single-authoritative-logic-path.md) — category: decision | tags: [architecture, networking, core] | ## Что решено
- [uid-as-player-identifier](pages/uid-as-player-identifier.md) — category: decision | tags: [networking, identity, history] | ## Что решено
