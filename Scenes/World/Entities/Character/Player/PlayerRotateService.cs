...
public class PlayerRotateService
{
    ...
    {
        Root.Instance.EventBus.Subscribe<PlayerUpdateEvent>(OnPlayerUpdateEvent);
    }
    
    public void OnPlayerUpdateEvent(PlayerUpdateEvent playerUpdateEvent) {
        RotateToMouse(playerUpdateEvent.Player, playerUpdateEvent.Delta);
    }
