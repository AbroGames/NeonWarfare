...
public static class PlayerAttackService
{
    ...
    {
        var player = ServerRoot.Instance.Game.PlayerProfiles[clientPlayerPrimaryAttackPacket.SenderId].Player;
    ...
    {
        var player = ServerRoot.Instance.Game.PlayerProfiles[clientPlayerSecondaryAttackPacket.SenderId].Player;
