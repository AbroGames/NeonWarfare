...
> * Тип: `.Net Executable`. Название: `Server`. Program Arguments: `--server`.
> * Тип: `.Net Executable`. Название: `Autoconnect (1)`. Program Arguments: `--auto-connect-ip 127.0.0.1`.  
> * Тип: `.Net Executable`. Название: `Autoconnect (2)`. Program Arguments: `--auto-connect-ip 127.0.0.1`.
